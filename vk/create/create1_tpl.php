...
$res = $VKAPI->api('places.getCities', array('country' => '1'));
foreach ($res['response'] as $n => $sp) {
  $cities[$n]->uid = $sp['cid'];
  $cities[$n]->title = $sp['title'];
}
?>
...
<SCRIPT type="text/javascript" src="/vk/create/create1.js?<?php echo $G->script_style; ?>"></SCRIPT>
