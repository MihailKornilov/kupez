<?php
if (!isset($WR[$vkUser['viewer_id']])) Header("Location:".$URL); // ïåðåâîä íà ãëàâíóþ ñòðàíèöó, åñëè ïîëüçîâàòåëþ íåëüçÿ ñìîòðåòü ýòó
include('incHeader.php');

/*
// ÓÑÒÀÍÎÂÊÀ ÂÐÅÌÅÍÈ ÏÎÑËÅÄÍÅÃÎ ÂÕÎÄÀ ÂÑÅÌ ÏÎÑÅÒÈÒÅËßÌ
...
// ÓÑÒÀÍÎÂÊÀ ÊÎËÈ×ÅÑÒÂÀ ÐÀÇÌÅÙ¨ÍÍÛÕ ÎÁÚßÂËÅÍÈÉ ÂÑÅÌ ÏÎÑÅÒÈÒÅËßÌ
$spisok=$VK->QueryObjectArray("select * from vk_user order by viewer_id");
foreach($spisok as $sp)
  {
...
// ÓÑÒÀÍÎÂÊÀ ÂÑÅÌ - ÓÑÒÀÍÎÂÈË ËÈ ÏÎËÜÇÎÂÀÒÅËÜ ÏÐÈËÎÆÅÍÈÅ
...
// ÓÑÒÀÍÎÂÊÀ ÂÑÅÌ - ÓÑÒÀÍÎÂÈË ËÈ ÏÎËÜÇÎÂÀÒÅËÜ ÑÑÛËÊÓ Â ËÅÂÎÅ ÌÅÍÞ
//$VK->Query("update vk_user set app_setup=0");
require_once('include/vkapi.class.php');
$VKAPI = new vkapi(2881875,'h9IjOkxIMwoW8agQkW3M');
$spisok=$VK->QueryObjectArray("select * from vk_user order by viewer_id desc limit 500,100");
