		...
		if(data[0].count>0)
			...
			for(var n=0;n<data.length;n++)
				...
				HTML+="<DIV class=unit>";
					...
					HTML+=data[n].txt;
					if(data[n].telefon) HTML+=" <B>Тел.: "+data[n].telefon+"</B>";
					if(data[n].adres) HTML+=" <B>Адрес: "+data[n].adres+"</B>";
			...
			if(data[0].page>0) HTML+="<DIV><DIV id=ajaxNext onclick=obNext("+data[0].page+");>Показать ещё объявления</DIV></DIV>";
