...
$("._image-spisok ._iview");c.length&&(a=c.eq(0).attr("val"),b=c.eq(0).find("img").attr("src"));var c=$("#txt").val().replace(/\n/g,"<br />"),d=1*$("#rubric_id").val(),e=1*$("#rubric_sub_id").val(),a='<div class="ob-unit"><table class="utab"><tr><td class="txt">'+(a?'<img src="'+b+'" class="_iview" val="'+a+'" />':"")+(d?'<span class="rub">'+RUBRIC_ASS[d]+"</span><u>»</u>":"")+(e?'<span class="rubsub">'+RUBRIC_SUB_ASS[e]+"</span><u>»</u>":"")+c+($("#telefon").val()?'<div class="tel">'+$("#telefon").val()+
...
cityShow=function(){0==$("#country_id").val()?$("#city_id")._select("remove"):$("#city_id_select").length||($("#city_id")._select({width:180,block:1,title0:"Город не указан",spisok:[],write:1,func:obPreview,funcKeyup:cityGet}),$("#city_id_select").vkHint({width:180,msg:'<div style="text-align:justify">Обязательно указывайте город, если Ваше объявление ориентировано только на него, иначе объявление будет отображаться только в общем списке.</div>',ugol:"left",top:-12,left:211,indent:15}))},wallTest=
function(a){VK.api("account.getAppPermissions",{},function(b){"number"==typeof b.response?b.response&8192?wallPost(a):(VK.addCallback("onSettingsChanged",function(c){c&8192&&(VK.removeCallback("onWindowFocus"),wallPost(a))}),VK.addCallback("onWindowFocus",function(){location.href=URL+"&p=ob"}),VK.callMethod("showSettingsBox",8192)):location.href=URL+"&p=ob"})},wallPost=function(a){VK.api("wall.post",{message:a.msg,attachments:(a.photo?a.photo+",":"")+"http://vk.com/kupezz"},function(b){b.response?
_msg("Объявление размещено на стене Вашей страницы.",function(){location.href=URL+"&p=ob&wallpost=1&insert_id="+a.insert_id}):location.href=URL+"&p=ob&wallpost=0&insert_id="+a.insert_id})},_post=function(a){function b(){$("#_post").remove();_backfon(!1)}a=$.extend({viewer_id:0,photo:"",name:"",dtime:"Дата и время",cont:"Содержание",sa_gazeta_id:0,sa_viewer_id:0,sa_name:""},a);var c='<div id="_post"><div class="head"><table><tr>'+(a.viewer_id?'<td class="im"><a href="//vk.com/id'+a.viewer_id+'" target="_blank">'+
a.photo+"</a>":"")+'<td><a class="close">Закрыть</a>'+(a.viewer_id?'<a class="uname" href="//vk.com/id'+a.viewer_id+'" target="_blank">'+a.name+"</a>":"")+'<div class="dtime">'+a.dtime+"</div></table></div>"+(a.sa?'<div class="psa">'+(a.sa_gazeta_id?"КупецЪ":"")+(a.sa_viewer_id?'<a href="'+URL+"&p=admin&id="+a.sa_viewer_id+'">'+a.sa_name+"</a>":"")+'<div class="ed"><a class="to-arch" val="'+a.id+'">в архив</a><div class="img_edit ob-edit" val="'+a.id+'"></div></div></div>':"")+'<div class="pcont"><div class="rub">'+
a.rub+'</div><div class="txt">'+a.txt+"</div>"+(a.images?'<div class="images">'+a.images+"</div>":"")+(a.tel?'<div class="tel">'+a.tel+"</div>":"")+(a.city?'<div class="city">'+a.city+"</div>":"")+'<div class="meter">Просмотры: '+a.view+'</div></div><div class="foot"><div class="msg">'+(a.msg?a.msg:"")+'</div><input type="text" id="inp" placeholder="Отправить сообщение автору объявления.." /><table class="dn"><tr><td class="photo"><a href="http://vk.com/id'+VIEWER_ID+'" target="_blank">'+U.photo+
'</a><td><textarea></textarea><tr><td class="photo"><td class="send"><div class="vkButton"><button>Отправить</button></div><input type="hidden" id="anon" /><input type="hidden" id="only_author" /></table></div></div>';$("#_post").length&&b();var d=$("body").append(c).find("#_post"),e=d.find("textarea");_backfon(d);a.images?c=10:(c=540-d.height(),c=Math.round(0>c?10:c/2));d.css("top",$(this).scrollTop()+(60<VK_SCROLL?VK_SCROLL-60:0)+c);d.find(".close,.ob-edit").click(b);d.find(".to-arch").click(function(){var a=
$(this),c=a.attr("val"),d={op:"ob_archive",id:c};a.hide();$.post(AJAX_MAIN,d,function(d){d.success?(b(),$("#ob"+c).remove()):a.fadeIn(700)},"json")});d.find("#inp").focus(function(){$(this).addClass("dn");d.find(".foot table").removeClass("dn");e.focus().autosize();$("#anon")._check({name:"Анонимно",func:function(a){d.find(".photo")[(a?"add":"remove")+"Class"]("dn");e.width(a?496:436).focus()}});$("#only_author")._check({name:"Только для получателя"});$("#only_author_check").vkHint({msg:"Если галочка установлена,<br />то сообщение будет видно<br />только автору объявления.",
top:-103,left:108});d.find(".foot .vkButton").click(function(){var c=$(this),b={op:"ob_post_msg",id:a.id,txt:$.trim(e.val()),anon:$("#anon").val(),only_author:$("#only_author").val()};b.txt&&!c.hasClass("_busy")&&(c.addClass("_busy"),$.post(AJAX_MAIN,b,function(a){c.removeClass("_busy");a.success&&(e.val(""),d.find(".msg").append(a.msg))},"json"))})})};
