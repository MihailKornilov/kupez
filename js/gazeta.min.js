var AJAX_GAZ=APP_HTML+"/ajax/gazeta.php?"+VALUES,clientAdd=function(a){function c(){var c={op:"client_add",person:$("#cperson").val(),fio:$("#fio").val(),telefon:$("#ctelefon").val(),org_name:$("#org_name").val(),adres:$("#cadres").val(),inn:$("#inn").val(),kpp:$("#kpp").val(),email:$("#email").val(),skidka:$("#cskidka").val()};0==c.person?b("Не выбрана категория",-48):c.fio||c.org_name?(e.process(),$.post(AJAX_GAZ,c,function(c){c.success?(e.close(),_msg("Новый клиент внесён."),"function"==typeof a?
a(c):document.location.href=URL+"&p=gazeta&d=client&d1=info&id="+c.uid):e.abort()},"json")):b("Необходимо указать контактное лицо<br />либо название организации",-61)}function b(a,c){e.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",top:c,left:131,indent:40,show:1,remove:1})}var d='<table class="client-add"><tr><td class="label">Категория:<td><input type="hidden" id="cperson"><a href="'+URL+'&p=gazeta&d=setup&d1=person" class="img_edit'+_tooltip("Настройка категорий клиентов",-95)+'</a><tr><td class="label">Контактное лицо (фио):<td><input type="text" id="fio" maxlength="200"><tr><td class="label">Название организации:<td><input type="text" id="org_name" maxlength="200"><tr><td class="label">Телефоны:<td><input type="text" id="ctelefon" maxlength="300"><tr><td class="label">Адрес:<td><input type="text" id="cadres" maxlength="200"><tr><td class="label">ИНН:<td><input type="text" id="inn" maxlength="100"><tr><td class="label">КПП:<td><input type="text" id="kpp" maxlength="100"><tr><td class="label">E-mail:<td><input type="text" id="email" maxlength="100"><tr><td class="label">Скидка:<td><input type="hidden" id="cskidka"></table>',
e=_dialog({top:40,width:440,head:"Добавление нoвого клиента",content:d,submit:c});$("#cperson")._select({width:180,title0:"Не выбрана",spisok:PERSON_SPISOK});$("#cskidka")._select({width:60,title0:"Нет",spisok:SKIDKA_SPISOK});$("#fio").focus();$("#fio,#org_name,#ctelefon,#cadres,#inn,#kpp,#email").keyEnter(c)},clientFilter=function(){var a={fast:cFind.inp(),person:$("#person").val(),order:$("#order").val(),skidka:$("#skidka").val(),dolg:$("#dolg").val(),gnyear:$("#gnyear").val(),nomer:$("#nomer").val()};
$(".filter")[a.fast?"hide":"show"]();return a},clientSpisokLoad=function(){var a=clientFilter(),c=$(".result");a.op="client_spisok";c.hasClass("busy")||(c.addClass("busy"),$.post(AJAX_GAZ,a,function(a){c.removeClass("busy");a.success&&(c.html(a.result),$(".left").html(a.spisok))},"json"))},zayavFilter=function(a,c){a={op:"zayav_spisok",find:$("#find")._search("val"),cat:$("#cat").val(),nopublic:$("#nopublic").val(),gnyear:$("#gnyear").val(),nomer:parseInt($("#nomer").val()),polosa:parseInt($("#polosa").val()),
polosa_color:$("#polosa_color").val()};"gnyear"==c&&($("#nomer")._select(0)._select("process"),a.nomer=0);"nomer"!=c&&a.nomer||(zayavPolosa(),$("#polosa")._select(0),a.polosa=0,$("#polosa_color_filter").hide(),$("#polosa_color")._radio(0),a.polosa_color=0);"polosa"==c&&($("#polosa_color")._radio(0),a.polosa_color=0);a.find&&escape(a.find);_cookie("zayav_find",escape(a.find));_cookie("zayav_cat",a.cat);_cookie("zayav_nopublic",a.nopublic);_cookie("zayav_gnyear",a.gnyear);_cookie("zayav_nomer",a.nomer);
_cookie("zayav_polosa",a.polosa);_cookie("zayav_polosa_color",a.polosa_color);$(".filter")[a.find?"hide":"show"]();$("#polosa_filter")[a.nomer?"show":"hide"]();$("#polosa_color_filter")[a.nomer&&1<a.polosa&&a.polosa<GN[a.nomer].pc?"show":"hide"]();return a},zayavSpisok=function(a,c){var b=zayavFilter(a,c);$("#mainLinks").hasClass("busy")||($("#mainLinks").addClass("busy"),$.post(AJAX_GAZ,b,function(a){$("#mainLinks").removeClass("busy");a.success&&($(".result").html(a.result),$(".left").html(a.spisok),
a.gn_sel&&$("#nomer")._select(a.gn_sel),zayavPub())},"json"))},zayavPolosa=function(){if(0!=$("#nomer").val()){for(var a=[{uid:1,title:"Первая"}],c=2;c<GN[$("#nomer").val()].pc;c++)a.push({uid:c,title:c+"-я"});a.push({uid:c,title:"Последняя "+c+"-я"});a.push({uid:103,title:"Внутренняя чёрно-белая"});a.push({uid:104,title:"Внутренняя цветная"});a.push({uid:105,title:"Внутренняя (полоса не указана)"});$("#polosa")._select({title0:"Любая полоса",spisok:a,func:zayavSpisok})}},zayavPub=function(){var a=
$(".topub");if(a.length){for(var c=[],b=2;b<GN[$("#nomer").val()].pc;b++)c.push({uid:b,title:b+"-я"});for(var b=0;b<a.length;b++){var d=a.eq(b),e=d.attr("id"),g=d.val();$("#"+e)._dropdown({spisok:POLOSA_SPISOK,func:function(a,b){zayavPubNomer(c,b,POLOSA_NUM[a],1);var d={op:"zayav_pub",pub_id:b.split("p")[1],dop:a},e=$("#"+b).parent();e.addClass("_busy");$.post(AJAX_GAZ,d,function(a){e.removeClass("_busy")},"json")}});zayavPubNomer(c,e,POLOSA_NUM[g]);d.removeClass("topub")}}},zayavPubNomer=function(a,
c,b,d){b?(d&&$("#n"+c).val(0),$("#n"+c)._dropdown({title0:"??",spisok:a,func:function(a){a={op:"zayav_pub_nomer",pub_id:c.split("p")[1],polosa:a};var b=$("#"+c).parent();b.addClass("_busy");$.post(AJAX_GAZ,a,function(a){b.removeClass("_busy")},"json")}})):$("#n"+c)._dropdown("remove")},zayavRubric=function(){$("#rubric_id")._select({width:120,title0:"Не указана",spisok:RUBRIC_SPISOK,func:function(a){$("#rubric_sub_id").val(0)._select("remove");zayavRubricSub(a)}})},zayavRubricSub=function(a){RUBRIC_SUB_SPISOK[a]&&
$("#rubric_sub_id")._select({width:180,title0:"Подрубрика не указана",spisok:RUBRIC_SUB_SPISOK[a]})},zayavObSumCalc=function(){var a=0,c="",b=$("#ztxt").val().replace(/\./g,"").replace(/,/g,"").replace(/\//g,"").replace(/\"/g,"").replace(/( +)/g," ").replace(/^\s+/g,"").replace(/\s+$/g,"");if(b.length){a+=1*TXT_CENA_FIRST;if(b.length>TXT_LEN_FIRST){var c=" = ",d=Math.ceil((b.length-TXT_LEN_FIRST)/TXT_LEN_NEXT),c=c+TXT_LEN_FIRST,e=b.length-TXT_LEN_FIRST-(d-1)*TXT_LEN_NEXT,a=a+d*TXT_CENA_NEXT;TXT_LEN_NEXT==
e&&d++;1<d&&(c+=" + "+TXT_LEN_NEXT);2<d&&(c+="x"+(d-1));TXT_LEN_NEXT>e&&(c+=" + "+e)}c="Длина: <b>"+b.length+"</b>"+c+"<br />Цена: <b>"+a+"</b> руб.<span>(без учёта доп. параметров)</span>";$("#txt-count").html(c)}else $("#txt-count").html("");window.gnGet.cena(a);"0"==$("#summa_manual").val()&&$("#summa").val(window.gnGet.summa())},zayavRekSumCalc=function(){var a=$(this),c=a.val(),b=a.attr("id"),d=$("#size_x").val(),e=$("#size_y").val(),d=REGEXP_CENA.test(d)?d.replace(",","."):0,e=REGEXP_CENA.test(e)?
e.replace(",","."):0,g=0;$("#kv_sm").val("");REGEXP_CENA.test(c)?(a.prev().remove(".hint"),(g=Math.round(d*e))&&$("#kv_sm").val(g)):a.vkHint({msg:'<span class="red">Не корректно введено значение.</span>',remove:1,indent:40,show:1,top:"size_x"==b?-57:-79,left:"size_x"==b?-33:20});window.gnGet.cena(g);"0"==$("#summa_manual").val()&&$("#summa").val(window.gnGet.summa());$("#skidka-txt").html(window.gnGet.skidka())},incomeSpisok=function(){var a={op:"income_spisok",day:$(".selected").val(),invoice_id:$("#invoice_id").val(),
worker_id:$("#worker_id").val()};$(".inc-path").addClass("_busy");$.post(AJAX_GAZ,a,function(a){$(".inc-path").removeClass("_busy");a.success&&($(".inc-path").html(a.path),$("#spisok").html(a.html))},"json")},expenseFilter=function(){for(var a=[],c=$("#monthList input"),b=1;12>=b;b++)1==c.eq(b-1).val()&&a.push(b);return{op:"expense_spisok",category:$("#category").val(),worker:$("#worker").val(),invoice_id:$("#invoice_id").val(),year:$("#year").val(),month:a.join()}},expenseSpisok=function(){$("#mainLinks").addClass("busy");
$.post(AJAX_GAZ,expenseFilter(),function(a){$("#mainLinks").removeClass("busy");a.success&&($("#spisok").html(a.html),$("#monthList").html(a.mon))},"json")},rz_nomer=function(a,c){if(!$("#mainLinks").hasClass("busy")){var b={op:"report_zayav_nomer",nomer:$("#nomer").val(),year:"gnyear"==c?a:0};$("#mainLinks").addClass("busy");$.post(AJAX_GAZ,b,function(a){$("#mainLinks").removeClass("busy");a.success&&($("#spisok").html(a.spisok),a.gn_sel&&($("#nomer")._select(a.gn_sel),$("#nomer")._select(a.gn_first)))},
"json")}};
$.fn.clientSel=function(a){function c(c){c={op:"client_sel",val:c||"",client_id:a.client_id};b._select("process");$.post(AJAX_GAZ,c,function(c){b._select("cancel");c.success&&(b._select(c.spisok),a.client_id&&(b._select(a.client_id),a.client_id=0))},"json")}var b=$(this);a=$.extend({width:270,add:null,client_id:b.val()||0,func:function(){}},a);a.add&&(a.add=function(){clientAdd(function(a){var c=[];c.push(a);b._select(c);b._select(a.uid)})});b._select({width:a.width,title0:"Начните вводить данные клиента...",spisok:[],
write:1,nofind:"Клиентов не найдено",func:a.func,funcAdd:a.add,funcKeyup:c});c();return b};
$.fn.gnGet=function(a){function c(c,b){c&&(t=GN_FIRST_ACTIVE,r=t+(b||0)+a.show);l.find("#darr").remove();var e="";for(f=t;f<r&&!(f>GN_LAST_ACTIVE);f++){var q=GN[f];q&&(e+='<table><tr><td><table class="gns-week'+(q.sel?" gnsel":"")+(q.prev?" prev":"")+'" val="'+f+'"><tr><td class="td"><b>'+q.week+'</b><span class="g">('+f+')</span><td class="td"><span class="g">выход</span> '+q.txt+'<td class="cena" id="cena'+f+'"></table><td class="vdop"><input type="hidden" id="vdop'+f+'" value="'+q.dop+'" /> <input type="hidden" id="pn'+
...
p.pn=a.gns[f][2],p=f)}c(1,p-GN_FIRST_ACTIVE+1);e()}else c();b();u.click(function(){var b=$(this),d=1*b.attr("val");g();if(b.hasClass("sel"))d=0,b.removeClass("sel");else for(u.removeClass("sel"),b.addClass("sel"),f=GN_FIRST_ACTIVE,b=d;b&&!(f>GN_LAST_ACTIVE);)GN[f]&&(GN[f].sel=1,b--,f++);e();c(1,d);a.func()});k.cena=function(a){v=a||0;h()};k.skidka=function(b){return void 0!=b?(a.skidka=b,h(),""):2==a.category&&m?"Сумма скидки: <b>"+m+"</b> руб.":""};k.summa=y;k.clear=function(d){a.category=d;a.manual=
0;s=m=a.skidka=0;u.removeClass("sel");g();c(1);b()};k.manual=function(b,c){a.manual=b;s=y();h();a.func()};k.manualSumma=function(a){s=REGEXP_CENA.test(a)?1*a.replace(",","."):0;h()};k.result=function(){var b=[],c=0;d(function(d){2!=a.category||d.dop||(c=1);b.push(d.n+":"+d.cena+":"+d.dop+":"+d.pn)});return c?"no_polosa":b.join()};return k};
$(document).on("click","#client ._next",function(){if(!$(this).hasClass("busy")){var a=$(this),c=clientFilter();c.op="client_next";c.page=a.attr("val");a.addClass("busy");$.post(AJAX_GAZ,c,function(b){b.success?(a.remove(),$("#client .left").append(b.spisok)):a.removeClass("busy")},"json")}}).on("click","#zayav ._next",function(){var a=$(this),c=zayavFilter();c.page=a.attr("val");a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_GAZ,c,function(b){b.success?(a.after(b.spisok).remove(),zayavPub()):
a.removeClass("busy")},"json"))}).on("click","#zayav .clear",function(){$("#find")._search("clear");$("#cat").rightLink(0);$("#nopublic")._check(0);$("#nomer")._select(GN_FIRST_ACTIVE);$("#polosa")._select(0);$("#polosa_color")._check(0);zayavSpisok()}).on("click",".income-add",function(){function a(){var a={op:"income_add",from:OPL.from,invoice_id:$("#invoice_id_add").val(),sum:$("#sum").val(),zayav_id:OPL.zayav_id||0,client_id:OPL.client_id||0,prim:$.trim($("#prim").val())};0==a.invoice_id?c("Не указан счёт"):
...
a+"</SPAN>",remove:1,indent:40,show:1,top:-48,left:115})}var b='<table class="income-add-tab">'+(OPL.client_fio?'<tr><td class="label">Клиент:<td>'+OPL.client_fio:"")+(OPL.zayav_name?'<tr><td class="label">Заявка:<td><b>'+OPL.zayav_name+"</b>":"")+'<tr><td class="label">На счёт:<td><input type="hidden" id="invoice_id_add"><a href="'+URL+'&p=gazeta&d=setup&d1=invoice" class="img_edit'+_tooltip("Настройка счетов",-57)+'</a><tr><td class="label">Сумма:<td><input type="text" id="sum" class="money" maxlength="11"> руб.<tr><td class="label">Комментарий:<td><input type="text" id="prim" maxlength="100"></table>',
d=_dialog({width:400,head:"Внесение платежа",content:b,submit:a});$("#sum").focus();$("#sum,#prim").keyEnter(a);$("#invoice_id_add")._select({width:180,title0:"Не указан",spisok:INVOICE_SPISOK,func:function(a){$("#sum").focus()}})}).on("click",".income-del",function(){for(var a=$(this),c=_dialog({width:300,head:"Удаление платежа",content:"<center><b>Подтвердите удаление платежа.</b></center>",butSubmit:"Удалить",submit:function(){var b={op:"income_del",id:a.attr("val")};c.process();$.post(AJAX_GAZ,
b,function(b){b.success?(a.remove(),c.close(),_msg("Платёж удалён")):c.abort()},"json")}});"TR"!=a[0].tagName;)a=a.parent()}).on("click","#income_next",function(){var a=$(this),c={op:"income_spisok",page:$(this).attr("val"),limit:$("#money_limit").val(),client_id:$("#money_client_id").val(),zayav_id:$("#money_zayav_id").val(),deleted:$("#money_deleted").val(),invoice_id:$("#money_invoice_id").val(),worker_id:$("#money_worker_id").val(),day:$(".selected").val()||""};a.hasClass("busy")||(a.addClass("busy"),
$.post(AJAX_GAZ,c,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json"))}).on("click",".expense #monthList div",expenseSpisok).on("click",".expense ._next",function(){var a=$(this),c=expenseFilter();c.page=a.attr("val");a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_GAZ,c,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json"))}).on("click",".expense .img_del",function(){for(var a=$(this),c=_dialog({width:300,head:"Удаление расхода",content:"<center><b>Подтвердите удаление расхода.</b></center>",
butSubmit:"Удалить",submit:function(){var b={op:"expense_del",id:a.attr("val")};c.process();$.post(AJAX_GAZ,b,function(b){b.success?(a.remove(),c.close(),_msg("Расход удалён")):c.abort()},"json")}});"TR"!=a[0].tagName;)a=a.parent()}).on("click",".invoice_set",function(){function a(){var a={op:"invoice_set",invoice_id:c,sum:$("#sum").val()};REGEXP_CENA.test(a.sum)?(b.process(),$.post(AJAX_GAZ,a,function(a){a.success?($("#invoice-spisok").html(a.i),b.close(),_msg("Баланс установлен.")):b.abort()},"json")):
(b.bottom.vkHint({msg:'<SPAN class="red">Некорректно указана сумма</SPAN>',remove:1,indent:40,show:1,top:-48,left:72}),$("#sum").focus())}var c=$(this).attr("val"),b=_dialog({width:320,head:"Установка текущей суммы счёта",content:'<table class="_dialog-tab"><tr><td class="label">Сумма:<td><input type="text" class="money" id="sum" maxlength="11"> руб.</table>',butSubmit:"Установить",submit:a});$("#sum").focus().keyEnter(a)}).on("click","#report.invoice .img_note",function(){var a=_dialog({top:20,width:570,
head:"История операций со счётом",load:1,butSubmit:"",butCancel:"Закрыть"}),c={op:"invoice_history",invoice_id:$(this).attr("val")};$.post(AJAX_GAZ,c,function(b){b.success?a.content.html(b.html):a.loadError()},"json")}).on("click","#history_next",function(){if(!$(this).hasClass("busy")){var a=$(this),c={op:"history_next",page:a.attr("val")};a.addClass("busy");$.post(AJAX_GAZ,c,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json")}}).ready(function(){$("#client").length&&(window.cFind=
...
fio:$("#fio").val(),telefon:$("#telefon").val(),org_name:$("#org_name").val(),adres:$("#adres").val(),inn:$("#inn").val(),kpp:$("#kpp").val(),email:$("#email").val(),skidka:$("#cskidka").val()};a.fio||a.org_name?(b.process(),$.post(AJAX_GAZ,a,function(a){a.success?(CLIENT=a,$("#clientInfo .left:first").html(a.html),b.close(),_msg("Данные изменены.")):b.abort()},"json")):b.bottom.vkHint({msg:'<SPAN class="red">Необходимо указать контактное лицо<br />либо название организации</SPAN>',top:-61,left:131,
indent:40,show:1,remove:1})}var c='<table class="client-add"><tr><td class="label">Категория:<td><input type="hidden" id="cperson" value="'+CLIENT.person+'" /><a href="'+URL+'&p=gazeta&d=setup&d1=person" class="img_edit'+_tooltip("Настройка категорий клиентов",-95)+'</a><tr><td class="label">Контактное лицо (фио):<td><input type="text" id="fio" maxlength="200" value="'+CLIENT.fio+'" /><tr><td class="label">Название организации:<td><input type="text" id="org_name" maxlength="200" value="'+CLIENT.org_name+
...
CLIENT.email+'" /><tr><td class="label">Скидка:<td><input type="hidden" id="cskidka" value="'+CLIENT.skidka+'" /></table>',b=_dialog({top:40,width:440,head:"Редактирование данных клиента",content:c,butSubmit:"Сохранить",submit:a});$("#cperson")._select({width:180,spisok:PERSON_SPISOK});$("#cskidka")._select({width:60,title0:"Нет",spisok:SKIDKA_SPISOK});$("#fio").focus();$("#fio,#org_name,#telefon,#adres,#inn,#kpp,#email").keyEnter(a)}),$(".rightLink .off").vkHint({width:130,msg:"Клиента можно удалить, если у него нет ни одной заявки",
ugol:"right",delayShow:700,top:-17,left:-164}),$(".cdel").click(function(){var a=_dialog({top:90,width:300,head:"Удаление клиента",content:"<center>Внимание!<br />Будут удалены все данные о клиенте,<br />его платежи и заметки.<br /><b>Подтвердите удаление.</b></center>",butSubmit:"Удалить",submit:function(){var c={op:"client_del",id:CLIENT.id};a.process();$.post(AJAX_GAZ,c,function(b){b.success?(a.close(),_msg("Клиент удален."),ADMIN?location.reload():location.href=URL+"&p=gazeta&d=client"):a.abort()},
...
ugol:"right",indent:10,top:-1,left:-182,delayShow:1500})._search({width:148,focus:1,enter:1,txt:"Быстрый поиск..",func:zayavSpisok}).inp(Z.find),$("#cat").rightLink(zayavSpisok),$(".img_word").click(function(){var a=$("#nomer").val();0==a?$(this).vkHint({width:150,ugol:"right",msg:"<span class=red>Не выбран номер газеты.</span>",indent:5,top:-26,left:-198,show:1,remove:1}):location.href=APP_HTML+"/view/ob-word.php?"+VALUES+"&gn="+a;return!1}).vkHint({ugol:"right",width:145,msg:'<span style="color:#444">Открыть список объявлений в газетном варианте в формате Microsoft Word.</span>',
indent:10,top:-30,left:-193}),$("#nopublic")._check(function(a,c){$(".filter_nomer").toggle();zayavSpisok(a,c)}),$("#nopublic_check").vkHint({width:145,msg:"Заявки, которые не публиковались ни в одном номере газеты.",indent:60,top:-64,left:-61}),$("#gnyear").years({center:zayavSpisok,func:zayavSpisok}),$("#nomer")._select({title0:"Номер не указан",spisok:GN_SEL,func:zayavSpisok}),zayavPolosa(),$("#polosa_color")._radio(zayavSpisok),zayavPub());$("#zayav-add").length&&($("#client_id").clientSel({add:1,
func:function(a,c,b){ZA.skidka=a?b.skidka:"";$("#skidka")._select(ZA.skidka);window.gnGet.skidka(ZA.skidka);"0"==$("#summa_manual").val()&&$("#summa").val(window.gnGet.summa());$("#skidka-txt").html(window.gnGet.skidka())}}),$("#category")._select({width:120,spisok:CATEGORY_SPISOK,func:function(a){$(".ob").addClass("dn");$("#rubric_id").val(0)._select("remove");$("#rubric_sub_id").val(0)._select("remove");$("#ztxt").val("");zayavObSumCalc();$("#telefon").val("");$("#adres").val("");$("#summa_manual")._check(0);
$(".rek").addClass("dn");$("#size_x").val("");$("#size_y").val("");$("#kv_sm").val("");$(".skd").addClass("dn");$("#skidka")._select(ZA.skidka);$("#skidka-txt").html("");$(".manual").addClass("dn");$("#summa").attr("readonly",!0).val(0);window.gnGet.clear(a);switch(a){case 1:$(".ob").removeClass("dn");$(".manual").removeClass("dn");zayavRubric();break;case 2:$(".rek").removeClass("dn");$(".skd").removeClass("dn");$(".manual").removeClass("dn");window.gnGet.skidka(ZA.skidka);break;default:$("#summa").attr("readonly",
!1)}}}),zayavRubric(),$("#ztxt").autosize().focus().keyup(zayavObSumCalc),$("#size_x").keyup(zayavRekSumCalc),$("#size_y").keyup(zayavRekSumCalc),window.gnGet=$("#gn_spisok").gnGet({func:function(){$("#summa").attr("readonly")&&($("#summa").val(window.gnGet.summa()),$("#skidka-txt").html(window.gnGet.skidka()))}}),$("#skidka")._select({width:60,title0:"Нет",spisok:SKIDKA_SPISOK,func:function(a){window.gnGet.skidka(a);"0"==$("#summa_manual").val()&&$("#summa").val(window.gnGet.summa());$("#skidka-txt").html(window.gnGet.skidka())}}),
$("#summa_manual")._check(function(a){$("#summa").attr("readonly",!a).focus();window.gnGet.manual(a);$("#skidka-txt").html(window.gnGet.skidka())}),$("#summa").keyup(function(){window.gnGet.manualSumma($(this).val())}),$("#note").autosize(),$(".vkButton").click(function(){function a(a){c.vkHint({msg:"<SPAN class=red>"+a+"</SPAN>",remove:1,indent:40,show:1,top:-58,left:-14})}var c=$(this),b={op:"zayav_add",client_id:$("#client_id").val(),category:$("#category").val(),rubric_id:$("#rubric_id").val(),
rubric_sub_id:$("#rubric_sub_id").val(),txt:$("#ztxt").val(),telefon:$("#telefon").val(),adres:$("#adres").val(),size_x:$("#size_x").val(),size_y:$("#size_y").val(),gns:window.gnGet.result(),skidka:$("#skidka").val(),summa_manual:$("#summa_manual").val(),note:$("#note").val()};1==b.category&&0==b.rubric_id?a("Не указана рубрика"):1!=b.category||b.txt?1!=b.category||b.telefon||b.adres?2==b.category&&0==b.client_id?a("Не выбран клиент"):2!=b.category||REGEXP_CENA.test(b.size_x)&&REGEXP_CENA.test(b.size_y)?
b.gns?"no_polosa"==b.gns?a("Необходимо указать полосы у всех номеров"):REGEXP_CENA.test($("#summa").val())?(c.addClass("busy"),$.post(AJAX_GAZ,b,function(a){a.success?(_msg("Заявка внесена."),location.href=URL+"&p=gazeta&d=zayav&d1=info&id="+a.id):c.removeClass("busy")},"json")):(a("Некорректно введена итоговая стоимость"),$("#summa").focus()):a("Нужно выбрать хотя бы один номер выпуска"):a("Некорректно указан размер блока"):(a("Укажите контактный телефон или адрес клиента"),$("#telefon").focus()):
(a("Введите текст объявления"),$("#ztxt").focus())}),$(".vkCancel").click(function(){location.href=URL+"&p=gazeta&d="+ZA.back}));$("#zayav-info").length&&($(".off").vkHint({msg:"Чтобы удалить эту заявку<br>привяжите её к клиенту.<br>Таким образом все платежи<br>этой заявки вернутся клиенту<br>на баланс после удаления.",ugol:"top",indent:120,top:17,left:426}),$(".zdel").click(function(){var a=_dialog({top:90,width:260,head:"Удаление заявки",content:"<center><b>Подтвердите удаление заявки</b></center>",
butSubmit:"Удалить",submit:function(){var c={op:"zayav_del",id:OPL.zayav_id};a.process();$.post(AJAX_GAZ,c,function(b){b.success?(a.close(),_msg("Заявка удален."),ADMIN?location.reload():location.href=URL+"&p=gazeta&d=client"):a.abort()},"json")}})}),$("#lost-count").click(function(){$(this).parent().find(".lost").show();$(this).remove()}),$(".zinfo").click(function(){$(this).parent().find(".sel").removeClass("sel");$(this).addClass("sel");$("#zayav-info").removeClass("h")}),$(".hist").click(function(){$(this).parent().find(".sel").removeClass("sel");
...
$("#summa").keyup(function(){window.gnGet.manualSumma($(this).val())});$(".vkButton").click(function(){function a(a){c.vkHint({msg:"<SPAN class=red>"+a+"</SPAN>",remove:1,indent:40,show:1,top:-58,left:-14})}var c=$(this),b={op:"zayav_edit",zayav_id:ZAYAV.id,client_id:$("#client_id").val(),gns:window.gnGet.result()};1==ZAYAV.category&&(b.rubric_id=$("#rubric_id").val(),b.rubric_sub_id=$("#rubric_sub_id").val(),b.txt=$("#ztxt").val(),b.telefon=$("#telefon").val(),b.adres=$("#adres").val());2==ZAYAV.category&&
(b.size_x=$("#size_x").val(),b.size_y=$("#size_y").val(),b.skidka=$("#skidka").val());3>ZAYAV.category&&(b.summa_manual=$("#summa_manual").val());1==ZAYAV.category&&0==b.rubric_id?a("Не указана рубрика"):1!=ZAYAV.category||b.txt?1!=ZAYAV.category||b.telefon||b.adres?2==ZAYAV.category&&0==b.client_id?a("Не выбран клиент"):2!=ZAYAV.category||REGEXP_CENA.test(b.size_x)&&REGEXP_CENA.test(b.size_y)?"no_polosa"==b.gns?a("Необходимо указать полосы у всех номеров"):REGEXP_CENA.test($("#summa").val())?(c.addClass("busy"),
$.post(AJAX_GAZ,b,function(a){a.success?(_msg("Заявка изменена."),location.href=URL+"&p=gazeta&d=zayav&d1=info&id="+ZAYAV.id):c.removeClass("busy")},"json")):(a("Некорректно введена итоговая стоимость"),$("#summa").focus()):a("Некорректно указан размер блока"):(a("Укажите контактный телефон или адрес клиента"),$("#telefon").focus()):(a("Введите текст объявления"),$("#ztxt").focus())});$(".vkCancel").click(function(){location.href=URL+"&p=gazeta&d=zayav&d1=info&id="+ZAYAV.id})}$("#report.income").length&&
...
0!=a.sum?(d.process(),$.post(AJAX_GAZ,a,function(a){a.success?(d.close(),_msg("Новый расход внесён."),expenseSpisok()):d.abort()},"json")):(c("Некорректно указана сумма."),$("#sum").focus()):c("Укажите с какого счёта производится оплата."):(c("Выберите категорию или укажите описание."),$("#about").focus())}function c(a){d.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",remove:1,indent:40,show:1,top:-47,left:101})}var b='<table id="expense-add-tab"><tr><td class="label">Категория:<TD><INPUT type="hidden" id="cat"><a href="'+
