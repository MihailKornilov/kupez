...
title:c+"-я"});for(var c=0;c<a.length;c++){var d=a.eq(c),e=d.attr("id"),g=d.val();$("#"+e)._dropdown({spisok:POLOSA_SPISOK,func:function(a,c){zayavPubNomer(b,c,POLOSA_NUM[a],1);var d={op:"zayav_pub",pub_id:c.split("p")[1],dop:a},e=$("#"+c).parent();e.addClass("_busy");$.post(AJAX_GAZ,d,function(a){e.removeClass("_busy")},"json")}});zayavPubNomer(b,e,POLOSA_NUM[g]);d.removeClass("topub")}}},zayavPubNomer=function(a,b,c,d){c?(d&&$("#n"+b).val(0),$("#n"+b)._dropdown({title0:"??",spisok:a,func:function(a){a=
{op:"zayav_pub_nomer",pub_id:b.split("p")[1],polosa:a};var c=$("#"+b).parent();c.addClass("_busy");$.post(AJAX_GAZ,a,function(a){c.removeClass("_busy")},"json")}})):$("#n"+b)._dropdown("remove")},zayavRubric=function(){$("#rubric_id")._select({width:120,title0:"Не указана",spisok:RUBRIC_SPISOK,func:function(a){$("#rubric_sub_id").val(0)._select("remove");zayavRubricSub(a)}})},zayavRubricSub=function(a){RUBRIC_SUB_SPISOK[a]&&$("#rubric_sub_id")._select({width:180,title0:"Подрубрика не указана",spisok:RUBRIC_SUB_SPISOK[a]})},
...
a.removeClass("busy")},"json"))}).on("click","#zayav .clear",function(){$("#find")._search("clear");$("#cat").rightLink(0);$("#nopublic")._check(0);$("#nomer")._select(GN_FIRST_ACTIVE);$("#polosa")._select(0);$("#polosa_color")._check(0);zayavSpisok()}).on("click",".income-add",function(){function a(){var a={op:"income_add",from:OPL.from,income_id:$("#income_id_add").val(),sum:$("#sum").val(),zayav_id:OPL.zayav_id||0,client_id:OPL.client_id||0,prim:$.trim($("#prim").val())};0==a.income_id?b("Не указан вид платежа"):
...
a+"</SPAN>",remove:1,indent:40,show:1,top:-48,left:115})}var c='<table class="income-add-tab">'+(OPL.client_fio?'<tr><td class="label">Клиент:<td>'+OPL.client_fio:"")+(OPL.zayav_name?'<tr><td class="label">Заявка:<td><b>'+OPL.zayav_name+"</b>":"")+'<tr><td class="label">Вид платежа:<td><input type="hidden" id="income_id_add"><a href="'+URL+'&p=gazeta&d=setup&d1=money" class="img_edit'+_tooltip("Настройка видов платежей",-85)+'</a><tr><td class="label">Сумма:<td><input type="text" id="sum" class="money" maxlength="11"> руб.<tr><td class="label">Комментарий:<td><input type="text" id="prim" maxlength="100"></table>',
