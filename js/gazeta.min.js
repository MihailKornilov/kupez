...
clientSpisokLoad=function(){var a=clientFilter(),b=$(".result");a.op="client_spisok";b.hasClass("busy")||(b.addClass("busy"),$.post(AJAX_GAZ,a,function(a){b.removeClass("busy");a.success&&(b.html(a.result),$(".left").html(a.spisok))},"json"))},zayavFilter=function(){return{op:"zayav_spisok",find:$("#fz-find").val(),client_id:$("#fz-client_id").val(),cat:$("#fz-cat").val(),gnyear:$("#fz-gnyear").val(),nomer:$("#fz-nomer").val(),nopublic:$("#fz-nopublic").val()}},zayavSpisok=function(a,b){var c=zayavFilter();
c[b]=a;"gnyear"==b&&($("#nomer")._select(0)._select("process"),c.nomer=0);$(".filter")[c.find?"hide":"show"]();$("#mainLinks").hasClass("busy")||($("#mainLinks").addClass("busy"),$.post(AJAX_GAZ,c,function(a){$("#mainLinks").removeClass("busy");a.success&&($(".result").html(a.result),$(".left").html(a.spisok),a.gn_sel&&$("#nomer")._select(a.gn_sel))},"json"))},zayavRubric=function(){$("#rubric_id")._select({width:120,title0:"Не указана",spisok:RUBRIC_SPISOK,func:function(a){$("#rubric_sub_id").val(0)._select("remove");
...
$("#size_y").val(),d=REGEXP_CENA.test(d)?d.replace(",","."):0,e=REGEXP_CENA.test(e)?e.replace(",","."):0,k=0;$("#kv_sm").val("");REGEXP_CENA.test(b)?(a.prev().remove(".hint"),(k=Math.round(d*e))&&$("#kv_sm").val(k)):a.vkHint({msg:'<span class="red">Не корректно введено значение.</span>',remove:1,indent:40,show:1,top:"size_x"==c?-57:-79,left:"size_x"==c?-33:20});window.gnGet.cena(k);"0"==$("#summa_manual").val()&&$("#summa").val(window.gnGet.summa());$("#skidka-txt").html(window.gnGet.skidka())},incomeSpisok=
function(){var a={op:"income_spisok",day:$(".selected").val(),income_id:$("#income_id").val(),worker_id:$("#worker_id").val()};$(".inc-path").addClass("_busy");$.post(AJAX_GAZ,a,function(a){$(".inc-path").removeClass("_busy");a.success&&($(".inc-path").html(a.path),$("#spisok").html(a.html))},"json")},expenseFilter=function(){for(var a=[],b=$("#monthList input"),c=1;12>=c;c++)1==b.eq(c-1).val()&&a.push(c);return{op:"expense_spisok",category:$("#category").val(),worker:$("#worker").val(),invoice_id:$("#invoice_id").val(),
year:$("#year").val(),month:a.join()}},expenseSpisok=function(){$("#mainLinks").addClass("busy");$.post(AJAX_GAZ,expenseFilter(),function(a){$("#mainLinks").removeClass("busy");a.success&&($("#spisok").html(a.html),$("#monthList").html(a.mon))},"json")};
...
f+'" value="'+q.pn+'" /></table>':end++}e+=r<GN_LAST_ACTIVE?'<div id="darr">&darr; &darr; &darr;</div>':"";w[c?"html":"append"](e);w.animate({height:w.find(".gns-week").length*z+"px"},300);c&&3>a.category&&d(function(c){$("#vdop"+c.n)._dropdown({title0:1==a.category?"Доп. параметр не указан":"Полоса не указана",spisok:1==a.category?OBDOP_SPISOK:POLOSA_SPISOK,func:function(b){GN[c.n].dop=b;g();a.func();if(2==a.category&&(GN[c.n].pn=0,$("#pn"+c.n).val(0)._dropdown("remove"),POLOSA_NUM[b])){b=[];for(f=
2;f<GN[c.n].pc;f++)b.push({uid:f,title:f+"-я"});$("#pn"+c.n)._dropdown({title0:"??",spisok:b,func:function(a){GN[c.n].pn=a}})}}});if(2==a.category&&POLOSA_NUM[c.dop]){var b=[];for(f=2;f<GN[c.n].pc;f++)b.push({uid:f,title:f+"-я"});$("#pn"+c.n)._dropdown({title0:"??",spisok:b,func:function(a){GN[c.n].pn=a}})}});g()}function c(){A._dropdown(2<a.category?"remove":{head:"Установить всем...",headgrey:1,title0:1==a.category?"Доп. параметр не указан":"Полоса не указана",nosel:1,spisok:1==a.category?OBDOP_SPISOK:
POLOSA_SPISOK,func:function(c){d(function(b){if(!b.prev&&($("#vdop"+b.n)._dropdown(c),b.dop=c,2==a.category)){b.pn=0;if(POLOSA_NUM[c])for(var d=[],e=2;e<GN[b.n].pc;e++)d.push({uid:e,title:e+"-я"});$("#pn"+b.n).val(0)._dropdown(POLOSA_NUM[c]?{title0:"??",spisok:d,func:function(a){GN[b.n].pn=a}}:"remove")}});g();a.func()}})}function d(a,c){for(var b=GN_FIRST_ACTIVE;b<=GN_LAST_ACTIVE;b++){var d=GN[b];d&&(c||d.sel)&&a(d,b)}}function e(){var c=0;d(function(){c++});if(c){var e="Выбран"+_end(c,["","о"])+
" "+c+" номер"+_end(c,["","a","ов"])+"<a>очистить</a>";x.html(e).find("a").click(function(){k();b(1);x.html("");u.removeClass("sel");a.func()})}else x.html("")}function k(){d(function(a,c){a.n=c;a.sel=0;a.prev=0;a.cena=0;a.dop=0;a.pn=0},1)}function g(){var c=0,b=0;switch(a.category){case 1:var e=0;a.manual&&(d(function(a){a.prev||(e++,4==e?e=0:b++)}),e=0,c=Math.round(s/b*1E6)/1E6);d(function(b){b.prev||(e++,4==e?(e=0,b.cena=0):b.cena=a.manual?c:v?v+(b.dop?OBDOP_CENA_ASS[b.dop]:0):0);l.find("#cena"+
...
100)})}}function y(){var a=0;d(function(b){b.prev||(a+=b.cena)});return Math.round(100*a)/100}a=$.extend({show:4,add:8,category:1,gns:null,skidka:0,manual:0,func:function(){}},a);var h=$(this),f,z=21,t=GN_FIRST_ACTIVE,r=t+a.show;h.html('<div id="gnGet"><table><tr><td><div id="dopLinks"><a class="link" val="4">Месяц</a><a class="link" val="13">3 месяца</a><a class="link" val="26">Полгода</a><a class="link" val="52">Год</a></div><td><input type="hidden" id="dopDef"></table><table class="gn-spisok"><tr><td id="selCount"><td><div id="gns"></div></table></div>');
...
b;g();a.func();if(2==a.category&&(GN[d].pn=0,$("#pn"+d).val(0)._dropdown("remove"),POLOSA_NUM[b])){b=[];for(f=2;f<GN[d].pc;f++)b.push({uid:f,title:f+"-я"});$("#pn"+d)._dropdown({title0:"??",spisok:b,func:function(a){GN[d].pn=a}})}}}:"remove"));e();g();a.func()});var l=$("#gnGet"),w=l.find("#gns"),u=l.find("#dopLinks a"),A=l.find("#dopDef"),x=l.find("#selCount"),v=0,s=0,m=0;k();if(a.gns){var p=0;for(f in a.gns){if(f>GN_LAST_ACTIVE)break;GN[f]&&(p=GN[f],p.sel=1,p.prev=1,p.cena=a.gns[f][0],p.dop=a.gns[f][1],
p.pn=a.gns[f][2],p=f)}b(1,p-GN_FIRST_ACTIVE+1);e()}else b();c();u.click(function(){var c=$(this),d=1*c.attr("val");k();if(c.hasClass("sel"))d=0,c.removeClass("sel");else for(u.removeClass("sel"),c.addClass("sel"),f=GN_FIRST_ACTIVE,c=d;c&&!(f>GN_LAST_ACTIVE);)GN[f]&&(GN[f].sel=1,c--,f++);e();b(1,d);a.func()});h.cena=function(a){v=a||0;g()};h.skidka=function(b){return void 0!=b?(a.skidka=b,g(),""):2==a.category&&m?"Сумма скидки: <b>"+m+"</b> руб.":""};h.summa=y;h.clear=function(d){a.category=d;a.manual=
0;s=m=a.skidka=0;u.removeClass("sel");k();b(1);c()};h.manual=function(b,c){a.manual=b;s=y();g();a.func()};h.manualSumma=function(a){s=REGEXP_CENA.test(a)?1*a.replace(",","."):0;g()};h.result=function(){var b=[],c=0;d(function(d){2!=a.category||d.dop||(c=1);b.push(d.n+":"+d.cena+":"+d.dop+":"+d.pn)});return c?"no_polosa":b.join()};return h};
$(document).on("click","#client ._next",function(){if(!$(this).hasClass("busy")){var a=$(this),b=clientFilter();b.op="client_next";b.page=a.attr("val");a.addClass("busy");$.post(AJAX_GAZ,b,function(b){b.success?(a.remove(),$("#client .left").append(b.spisok)):a.removeClass("busy")},"json")}}).on("click",".zayav_next",function(){var a=$(this),b=zayavFilter();b.page=a.attr("val");a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_GAZ,b,function(b){b.success?a.after(b.spisok).remove():a.removeClass("busy")},
"json"))}).on("click",".income-add",function(){function a(){var a={op:"income_add",from:OPL.from,income_id:$("#income_id_add").val(),sum:$("#sum").val(),zayav_id:OPL.zayav_id||0,client_id:OPL.client_id||0,prim:$.trim($("#prim").val())};0==a.income_id?b("Не указан вид платежа"):REGEXP_CENA.test(a.sum)&&0!=a.sum?a.zayav_id||a.prim?(d.process(),$.post(AJAX_GAZ,a,function(a){if(a.success)switch(d.close(),_msg("Платёж успешно внесён!"),OPL.from){case "client":$("#income_spisok").html(a.html);$(".left:first").html(a.balans);
break;case "zayav":$("#income_spisok").html(a.html);$(".zdel").remove();break;case "income":incomeSpisok()}else d.abort()},"json")):(b("Необходимо указать комментарий"),$("#prim").focus()):(b("Некорректно указана сумма."),$("#sum").focus())}function b(a){d.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",remove:1,indent:40,show:1,top:-48,left:115})}var c='<table class="income-add-tab">'+(OPL.client_fio?'<tr><td class="label">Клиент:<td>'+OPL.client_fio:"")+(OPL.zayav_name?'<tr><td class="label">Заявка:<td><b>'+
OPL.zayav_name+"</b>":"")+'<tr><td class="label">Вид платежа:<td><input type="hidden" id="income_id_add"><a href="'+URL+'&p=gazeta&d=setup&d1=money" class="img_edit'+_tooltip("Настройка видов платежей",-85)+'</a><tr><td class="label">Сумма:<td><input type="text" id="sum" class="money" maxlength="11"> руб.<tr><td class="label">Комментарий:<td><input type="text" id="prim" maxlength="100"></table>',d=_dialog({width:400,head:"Внесение платежа",content:c,submit:a});$("#sum").focus();$("#sum,#prim").keyEnter(a);
$("#income_id_add")._select({width:180,title0:"Не указан",spisok:INCOME_SPISOK,func:function(a){$("#sum").focus()}})}).on("click",".income-del",function(){for(var a=$(this),b=_dialog({width:300,head:"Удаление платежа",content:"<center><b>Подтвердите удаление платежа.</b></center>",butSubmit:"Удалить",submit:function(){var c={op:"income_del",id:a.attr("val")};b.process();$.post(AJAX_GAZ,c,function(c){c.success?(a.remove(),b.close(),_msg("Платёж удалён")):b.abort()},"json")}});"TR"!=a[0].tagName;)a=
a.parent()}).on("click","#income_next",function(){var a=$(this),b={op:"income_spisok",page:$(this).attr("val"),limit:$("#money_limit").val(),client_id:$("#money_client_id").val(),zayav_id:$("#money_zayav_id").val(),deleted:$("#money_deleted").val(),income_id:$("#money_income_id").val(),worker_id:$("#money_worker_id").val(),day:$(".selected").val()||""};a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_GAZ,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json"))}).on("click",
".expense #monthList div",expenseSpisok).on("click",".expense ._next",function(){var a=$(this),b=expenseFilter();b.page=a.attr("val");a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_GAZ,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json"))}).on("click",".expense .img_del",function(){for(var a=$(this),b=_dialog({width:300,head:"Удаление расхода",content:"<center><b>Подтвердите удаление расхода.</b></center>",butSubmit:"Удалить",submit:function(){var c={op:"expense_del",
id:a.attr("val")};b.process();$.post(AJAX_GAZ,c,function(c){c.success?(a.remove(),b.close(),_msg("Расход удалён")):b.abort()},"json")}});"TR"!=a[0].tagName;)a=a.parent()}).on("click",".invoice_set",function(){function a(){var a={op:"invoice_set",invoice_id:b,sum:$("#sum").val()};REGEXP_CENA.test(a.sum)?(c.process(),$.post(AJAX_GAZ,a,function(a){a.success?($("#invoice-spisok").html(a.i),c.close(),_msg("Баланс установлен.")):c.abort()},"json")):(c.bottom.vkHint({msg:'<SPAN class="red">Некорректно указана сумма</SPAN>',
remove:1,indent:40,show:1,top:-48,left:72}),$("#sum").focus())}var b=$(this).attr("val"),c=_dialog({width:320,head:"Установка текущей суммы счёта",content:'<table class="_dialog-tab"><tr><td class="label">Сумма:<td><input type="text" class="money" id="sum" maxlength="11"> руб.</table>',butSubmit:"Установить",submit:a});$("#sum").focus().keyEnter(a)}).on("click","#report.invoice .img_note",function(){var a=_dialog({top:20,width:570,head:"История операций со счётом",load:1,butSubmit:"",butCancel:"Закрыть"}),
b={op:"invoice_history",invoice_id:$(this).attr("val")};$.post(AJAX_GAZ,b,function(b){b.success?a.content.html(b.html):a.loadError()},"json")}).on("click","#history_next",function(){if(!$(this).hasClass("busy")){var a=$(this),b={op:"history_next",page:a.attr("val")};a.addClass("busy");$.post(AJAX_GAZ,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json")}}).ready(function(){$("#client").length&&(window.cFind=$("#find")._search({width:602,focus:1,enter:1,txt:"Введите данные клиента и нажмите Enter",
...
correct:0}));$("#clientInfo").length&&($(".cedit").click(function(){function a(){var a={op:"client_edit",id:CLIENT.id,person:$("#cperson").val(),fio:$("#fio").val(),telefon:$("#telefon").val(),org_name:$("#org_name").val(),adres:$("#adres").val(),inn:$("#inn").val(),kpp:$("#kpp").val(),email:$("#email").val(),skidka:$("#cskidka").val()};a.fio||a.org_name?(c.process(),$.post(AJAX_GAZ,a,function(a){a.success?(CLIENT=a,$("#clientInfo .left:first").html(a.html),c.close(),_msg("Данные изменены.")):c.abort()},
"json")):c.bottom.vkHint({msg:'<SPAN class="red">Необходимо указать контактное лицо<br />либо название организации</SPAN>',top:-61,left:131,indent:40,show:1,remove:1})}var b='<table class="client-add"><tr><td class="label">Категория:<td><input type="hidden" id="cperson" value="'+CLIENT.person+'" /><a href="'+URL+'&p=gazeta&d=setup&d1=person" class="img_edit'+_tooltip("Настройка категорий клиентов",-95)+'</a><tr><td class="label">Контактное лицо (фио):<td><input type="text" id="fio" maxlength="200" value="'+
...
CLIENT.kpp+'" /><tr><td class="label">E-mail:<td><input type="text" id="email" maxlength="100" value="'+CLIENT.email+'" /><tr><td class="label">Скидка:<td><input type="hidden" id="cskidka" value="'+CLIENT.skidka+'" /></table>',c=_dialog({top:40,width:440,head:"Редактирование данных клиента",content:b,butSubmit:"Сохранить",submit:a});$("#cperson")._select({width:180,spisok:PERSON_SPISOK});$("#cskidka")._select({width:60,title0:"Нет",spisok:SKIDKA_SPISOK});$("#fio").focus();$("#fio,#org_name,#telefon,#adres,#inn,#kpp,#email").keyEnter(a)}),
$(".rightLink .off").vkHint({width:130,msg:"Клиента можно удалить, если у него нет ни одной заявки",ugol:"right",delayShow:700,top:-17,left:-164}),$(".cdel").click(function(){var a=_dialog({top:90,width:300,head:"Удаление клиента",content:"<center>Внимание!<br />Будут удалены все данные о клиенте,<br />его платежи и заметки.<br /><b>Подтвердите удаление.</b></center>",butSubmit:"Удалить",submit:function(){var b={op:"client_del",id:CLIENT.id};a.process();$.post(AJAX_GAZ,b,function(b){b.success?(a.close(),
...
a+"</SPAN>",remove:1,indent:40,show:1,top:-58,left:-14})}var b=$(this),c={op:"zayav_add",client_id:$("#client_id").val(),category:$("#category").val(),rubric_id:$("#rubric_id").val(),rubric_sub_id:$("#rubric_sub_id").val(),txt:$("#ztxt").val(),telefon:$("#telefon").val(),adres:$("#adres").val(),size_x:$("#size_x").val(),size_y:$("#size_y").val(),gns:window.gnGet.result(),skidka:$("#skidka").val(),summa_manual:$("#summa_manual").val(),note:$("#note").val()};1==c.category&&0==c.rubric_id?a("Не указана рубрика"):
1!=c.category||c.txt?1!=c.category||c.telefon||c.adres?2==c.category&&0==c.client_id?a("Не выбран клиент"):2!=c.category||REGEXP_CENA.test(c.size_x)&&REGEXP_CENA.test(c.size_y)?c.gns?"no_polosa"==c.gns?a("Необходимо указать полосы у всех номеров"):REGEXP_CENA.test($("#summa").val())?(b.addClass("busy"),$.post(AJAX_GAZ,c,function(a){a.success?(_msg("Заявка внесена."),location.href=URL+"&p=gazeta&d=zayav&d1=info&id="+a.id):b.removeClass("busy")},"json")):(a("Некорректно введена итоговая стоимость"),
$("#summa").focus()):a("Нужно выбрать хотя бы один номер выпуска"):a("Некорректно указан размер блока"):(a("Укажите контактный телефон или адрес клиента"),$("#telefon").focus()):(a("Введите текст объявления"),$("#ztxt").focus())}),$(".vkCancel").click(function(){location.href=URL+"&p=gazeta&d="+ZA.back}));$("#zayav-info").length&&($(".off").vkHint({msg:"Чтобы удалить эту заявку<br>привяжите её к клиенту.<br>Таким образом все платежи<br>этой заявки вернутся клиенту<br>на баланс после удаления.",ugol:"top",
indent:120,top:17,left:426}),$(".zdel").click(function(){var a=_dialog({top:90,width:260,head:"Удаление заявки",content:"<center><b>Подтвердите удаление заявки</b></center>",butSubmit:"Удалить",submit:function(){var b={op:"zayav_del",id:OPL.zayav_id};a.process();$.post(AJAX_GAZ,b,function(b){b.success?(a.close(),_msg("Заявка удален."),ADMIN?location.reload():location.href=URL+"&p=gazeta&d=client"):a.abort()},"json")}})}),$("#lost-count").click(function(){$(this).parent().find(".lost").show();$(this).remove()}),
$(".zinfo").click(function(){$(this).parent().find(".sel").removeClass("sel");$(this).addClass("sel");$("#zayav-info").removeClass("h")}),$(".hist").click(function(){$(this).parent().find(".sel").removeClass("sel");$(this).addClass("sel");$("#zayav-info").addClass("h")}));if($("#zayav-edit").length){0==$("#client_id").val()&&$("#client_id").clientSel({add:1});window.gnGet=$("#gn_spisok").gnGet({category:ZAYAV.category,gns:ZAYAV.gns,skidka:ZAYAV.skidka,manual:ZAYAV.manual,func:function(){$("#summa").attr("readonly")&&
...
1==ZAYAV.category&&(c.rubric_id=$("#rubric_id").val(),c.rubric_sub_id=$("#rubric_sub_id").val(),c.txt=$("#ztxt").val(),c.telefon=$("#telefon").val(),c.adres=$("#adres").val());2==ZAYAV.category&&(c.size_x=$("#size_x").val(),c.size_y=$("#size_y").val(),c.skidka=$("#skidka").val());3>ZAYAV.category&&(c.summa_manual=$("#summa_manual").val());1==ZAYAV.category&&0==c.rubric_id?a("Не указана рубрика"):1!=ZAYAV.category||c.txt?1!=ZAYAV.category||c.telefon||c.adres?2==ZAYAV.category&&0==c.client_id?a("Не выбран клиент"):
2!=ZAYAV.category||REGEXP_CENA.test(c.size_x)&&REGEXP_CENA.test(c.size_y)?"no_polosa"==c.gns?a("Необходимо указать полосы у всех номеров"):REGEXP_CENA.test($("#summa").val())?(b.addClass("busy"),$.post(AJAX_GAZ,c,function(a){a.success?(_msg("Заявка изменена."),location.href=URL+"&p=gazeta&d=zayav&d1=info&id="+ZAYAV.id):b.removeClass("busy")},"json")):(a("Некорректно введена итоговая стоимость"),$("#summa").focus()):a("Некорректно указан размер блока"):(a("Укажите контактный телефон или адрес клиента"),
$("#telefon").focus()):(a("Введите текст объявления"),$("#ztxt").focus())});$(".vkCancel").click(function(){location.href=URL+"&p=gazeta&d=zayav&d1=info&id="+ZAYAV.id})}$("#report.income").length&&(window._calendarFilter=incomeSpisok,$("#income_id")._select({width:160,title0:"Любые платежи",spisok:INCOME_SPISOK,func:incomeSpisok}),window.WORKERS&&$("#worker_id")._select({width:160,title0:"Все сотрудники",spisok:WORKERS,func:incomeSpisok}));$("#report.expense").length&&($(".add").click(function(){function a(){var a=
{op:"expense_add",category:1*$("#cat").val(),about:$("#about").val(),worker:$("#work").val(),invoice:1*$("#invoice").val(),sum:$("#sum").val()};a.category||a.about?a.invoice?REGEXP_CENA.test(a.sum)&&0!=a.sum?(d.process(),$.post(AJAX_GAZ,a,function(a){a.success?(d.close(),_msg("Новый расход внесён."),expenseSpisok()):d.abort()},"json")):(b("Некорректно указана сумма."),$("#sum").focus()):b("Укажите с какого счёта производится оплата."):(b("Выберите категорию или укажите описание."),$("#about").focus())}
function b(a){d.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",remove:1,indent:40,show:1,top:-47,left:101})}var c='<table id="expense-add-tab"><tr><td class="label">Категория:<TD><INPUT type="hidden" id="cat"><a href="'+URL+'&p=gazeta&d=setup&d1=expense" class="img_edit'+_tooltip("Настройка категорий расходов",-95)+'</a><tr class="tr-work dn"><td class="label">Сотрудник:<TD><INPUT type="hidden" id="work"><tr><td class="label">Описание:<TD><INPUT type="text" id="about" maxlength="100"><tr><td class="label">Со счёта:<TD><INPUT type="hidden" id="invoice"><a href="'+
URL+'&p=gazeta&d=setup&d1=invoice" class="img_edit'+_tooltip("Настройка счетов",-56)+'</a><tr><td class="label">Сумма:<TD><INPUT type="text" id="sum" class="money" maxlength="11"> руб.</table>',d=_dialog({width:380,head:"Внесение расхода",content:c,submit:a});$("#cat")._select({width:180,title0:"Не указана",spisok:EXPENSE_SPISOK,func:function(a){$("#work")._select(0);$(".tr-work")[(EXPENSE_WORKER[a]?"remove":"add")+"Class"]("dn")}});$("#about").focus();$("#work")._select({title0:"Не выбран",spisok:WORKER_SPISOK,
...
$("#monthList input"),b=0;for(n=1;12>=n;n++)if(0==a.eq(n-1).val()){b=1;break}for(n=1;12>=n;n++)$("#c"+n)._check(b);expenseSpisok()}}));$("#report.invoice").length&&$(".transfer").click(function(){function a(){var a={op:"invoice_transfer",from:1*$("#from").val(),to:1*$("#to").val(),sum:$("#sum").val(),note:$("#note").val()};a.from?a.to?a.from==a.to?b("Выберите другой счёт"):REGEXP_CENA.test(a.sum)&&0!=a.sum?(c.process(),$.post(AJAX_GAZ,a,function(a){a.success?($("#invoice-spisok").html(a.i),$("#transfer-spisok").html(a.t),
c.close(),_msg("Перевод произведён.")):c.abort()},"json")):(b("Некорректно введена сумма"),$("#sum").focus()):b("Выберите счёт-получатель"):b("Выберите счёт-отправитель")}function b(a){c.bottom.vkHint({msg:'<span class="red">'+a+"</span>",top:-47,left:92,indent:50,show:1,remove:1})}$(this);var c=_dialog({width:380,head:"Перевод между счетами",content:'<table class="invoice-transfer"><tr><td class="label">Со счёта:<td><input type="hidden" id="from" /><tr><td class="label">На счёт:<td><input type="hidden" id="to" /><tr><td class="label">Сумма:<td><input type="text" id="sum" class="money" /> руб. <tr><td class="label">Комментарий:<td><input type="text" id="note" /></table>',
butSubmit:"Применить",submit:a});$("#from")._select({width:250,title0:"Не выбран",spisok:INVOICE_SPISOK});$("#to")._select({width:250,title0:"Не выбран",spisok:INVOICE_SPISOK});$("#sum").keyEnter(a)})});
