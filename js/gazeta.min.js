...
CLIENT.kpp+'" /><tr><td class="label">E-mail:<td><input type="text" id="email" maxlength="100" value="'+CLIENT.email+'" /><tr><td class="label">Скидка:<td><input type="hidden" id="cskidka" value="'+CLIENT.skidka+'" /></table>',b=_dialog({top:40,width:440,head:"Редактирование данных клиента",content:c,submit:a});$("#cperson")._select({width:180,spisok:PERSON_SPISOK});$("#cskidka")._select({width:60,title0:"Нет",spisok:SKIDKA_SPISOK});$("#fio").focus();$("#fio,#org_name,#telefon,#adres,#inn,#kpp,#email").keyEnter(a)}),
