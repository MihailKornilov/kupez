...
b[c]=a;"gnyear"==c&&($("#nomer")._select(0)._select("process"),b.nomer=0);$(".filter")[b.find?"hide":"show"]();$("#mainLinks").hasClass("busy")||($("#mainLinks").addClass("busy"),$.post(AJAX_GAZ,b,function(a){$("#mainLinks").removeClass("busy");a.success&&($(".result").html(a.result),$(".left").html(a.spisok),a.gn_sel&&$("#nomer")._select(a.gn_sel),zayavPub())},"json"))},zayavPub=function(){var a=$(".topub");if(a.length){for(var c=[],b=2;b<GN[$("#fz-nomer").val()].pc;b++)c.push({uid:b,title:b+"-я"});
for(var b=0;b<a.length;b++){var d=a.eq(b),e=d.attr("id"),g=d.val();$("#"+e)._dropdown({spisok:POLOSA_SPISOK,func:function(a,b){zayavPubNomer(c,b,POLOSA_NUM[a],1);var d={op:"zayav_pub",pub_id:b.split("p")[1],dop:a},e=$("#"+b).parent();e.addClass("_busy");$.post(AJAX_GAZ,d,function(a){e.removeClass("_busy")},"json")}});zayavPubNomer(c,e,POLOSA_NUM[g]);d.removeClass("topub")}}},zayavPubNomer=function(a,c,b,d){b?(d&&$("#n"+c).val(0),$("#n"+c)._dropdown({title0:"??",spisok:a,func:function(a){a={op:"zayav_pub_nomer",
pub_id:c.split("p")[1],polosa:a};var b=$("#"+c).parent();b.addClass("_busy");$.post(AJAX_GAZ,a,function(a){b.removeClass("_busy")},"json")}})):$("#n"+c)._dropdown("remove")},zayavRubric=function(){$("#rubric_id")._select({width:120,title0:"Не указана",spisok:RUBRIC_SPISOK,func:function(a){$("#rubric_sub_id").val(0)._select("remove");zayavRubricSub(a)}})},zayavRubricSub=function(a){RUBRIC_SUB_SPISOK[a]&&$("#rubric_sub_id")._select({width:180,title0:"Подрубрика не указана",spisok:RUBRIC_SUB_SPISOK[a]})},
zayavObSumCalc=function(){var a=0,c="",b=$("#ztxt").val().replace(/\./g,"").replace(/,/g,"").replace(/\//g,"").replace(/\"/g,"").replace(/( +)/g," ").replace(/^\s+/g,"").replace(/\s+$/g,"");if(b.length){a+=1*TXT_CENA_FIRST;if(b.length>TXT_LEN_FIRST){var c=" = ",d=Math.ceil((b.length-TXT_LEN_FIRST)/TXT_LEN_NEXT),c=c+TXT_LEN_FIRST,e=b.length-TXT_LEN_FIRST-(d-1)*TXT_LEN_NEXT,a=a+d*TXT_CENA_NEXT;TXT_LEN_NEXT==e&&d++;1<d&&(c+=" + "+TXT_LEN_NEXT);2<d&&(c+="x"+(d-1));TXT_LEN_NEXT>e&&(c+=" + "+e)}c="Длина: <b>"+
b.length+"</b>"+c+"<br />Цена: <b>"+a+"</b> руб.<span>(без учёта доп. параметров)</span>";$("#txt-count").html(c)}else $("#txt-count").html("");window.gnGet.cena(a);"0"==$("#summa_manual").val()&&$("#summa").val(window.gnGet.summa())},zayavRekSumCalc=function(){var a=$(this),c=a.val(),b=a.attr("id"),d=$("#size_x").val(),e=$("#size_y").val(),d=REGEXP_CENA.test(d)?d.replace(",","."):0,e=REGEXP_CENA.test(e)?e.replace(",","."):0,g=0;$("#kv_sm").val("");REGEXP_CENA.test(c)?(a.prev().remove(".hint"),(g=
Math.round(d*e))&&$("#kv_sm").val(g)):a.vkHint({msg:'<span class="red">Не корректно введено значение.</span>',remove:1,indent:40,show:1,top:"size_x"==b?-57:-79,left:"size_x"==b?-33:20});window.gnGet.cena(g);"0"==$("#summa_manual").val()&&$("#summa").val(window.gnGet.summa());$("#skidka-txt").html(window.gnGet.skidka())},incomeSpisok=function(){var a={op:"income_spisok",day:$(".selected").val(),income_id:$("#income_id").val(),worker_id:$("#worker_id").val()};$(".inc-path").addClass("_busy");$.post(AJAX_GAZ,
a,function(a){$(".inc-path").removeClass("_busy");a.success&&($(".inc-path").html(a.path),$("#spisok").html(a.html))},"json")},expenseFilter=function(){for(var a=[],c=$("#monthList input"),b=1;12>=b;b++)1==c.eq(b-1).val()&&a.push(b);return{op:"expense_spisok",category:$("#category").val(),worker:$("#worker").val(),invoice_id:$("#invoice_id").val(),year:$("#year").val(),month:a.join()}},expenseSpisok=function(){$("#mainLinks").addClass("busy");$.post(AJAX_GAZ,expenseFilter(),function(a){$("#mainLinks").removeClass("busy");
...
$.fn.gnGet=function(a){function c(b,c){b&&(t=GN_FIRST_ACTIVE,r=t+(c||0)+a.show);l.find("#darr").remove();var e="";for(f=t;f<r&&!(f>GN_LAST_ACTIVE);f++){var q=GN[f];q?e+='<table><tr><td><table class="gns-week'+(q.sel?" gnsel":"")+(q.prev?" prev":"")+'" val="'+f+'"><tr><td class="td"><b>'+q.week+'</b><span class="g">('+f+')</span><td class="td"><span class="g">выход</span> '+q.txt+'<td class="cena" id="cena'+f+'"></table><td class="vdop"><input type="hidden" id="vdop'+f+'" value="'+q.dop+'" /> <input type="hidden" id="pn'+
f+'" value="'+q.pn+'" /></table>':end++}e+=r<GN_LAST_ACTIVE?'<div id="darr">&darr; &darr; &darr;</div>':"";w[b?"html":"append"](e);w.animate({height:w.find(".gns-week").length*z+"px"},300);b&&3>a.category&&d(function(b){$("#vdop"+b.n)._dropdown({title0:1==a.category?"Доп. параметр не указан":"Полоса не указана",spisok:1==a.category?OBDOP_SPISOK:POLOSA_SPISOK,func:function(c){GN[b.n].dop=c;h();a.func();if(2==a.category&&(GN[b.n].pn=0,$("#pn"+b.n).val(0)._dropdown("remove"),POLOSA_NUM[c])){c=[];for(d=
2;d<GN[b.n].pc;d++)c.push({uid:d,title:d+"-я"});$("#pn"+b.n)._dropdown({title0:"??",spisok:c,func:function(a){GN[b.n].pn=a}})}}});if(2==a.category&&POLOSA_NUM[b.dop]){for(var c=[],d=2;d<GN[b.n].pc;d++)c.push({uid:d,title:d+"-я"});$("#pn"+b.n)._dropdown({title0:"??",spisok:c,func:function(a){GN[b.n].pn=a}})}});h()}function b(){A._dropdown(2<a.category?"remove":{head:"Установить всем...",headgrey:1,title0:1==a.category?"Доп. параметр не указан":"Полоса не указана",nosel:1,spisok:1==a.category?OBDOP_SPISOK:
POLOSA_SPISOK,func:function(b){d(function(c){if(!c.prev&&($("#vdop"+c.n)._dropdown(b),c.dop=b,2==a.category)){c.pn=0;if(POLOSA_NUM[b])for(var d=[],e=2;e<GN[c.n].pc;e++)d.push({uid:e,title:e+"-я"});$("#pn"+c.n).val(0)._dropdown(POLOSA_NUM[b]?{title0:"??",spisok:d,func:function(a){GN[c.n].pn=a}}:"remove")}});h();a.func()}})}function d(a,b){for(var c=GN_FIRST_ACTIVE;c<=GN_LAST_ACTIVE;c++){var d=GN[c];d&&(b||d.sel)&&a(d,c)}}function e(){var b=0;d(function(){b++});if(b){var e="Выбран"+_end(b,["","о"])+
...
$(document).on("click","#client ._next",function(){if(!$(this).hasClass("busy")){var a=$(this),c=clientFilter();c.op="client_next";c.page=a.attr("val");a.addClass("busy");$.post(AJAX_GAZ,c,function(b){b.success?(a.remove(),$("#client .left").append(b.spisok)):a.removeClass("busy")},"json")}}).on("click",".zayav_next",function(){var a=$(this),c=zayavFilter();c.page=a.attr("val");a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_GAZ,c,function(b){b.success?(a.after(b.spisok).remove(),zayavPub()):
a.removeClass("busy")},"json"))}).on("click",".income-add",function(){function a(){var a={op:"income_add",from:OPL.from,income_id:$("#income_id_add").val(),sum:$("#sum").val(),zayav_id:OPL.zayav_id||0,client_id:OPL.client_id||0,prim:$.trim($("#prim").val())};0==a.income_id?c("Не указан вид платежа"):REGEXP_CENA.test(a.sum)&&0!=a.sum?a.zayav_id||a.prim?(d.process(),$.post(AJAX_GAZ,a,function(a){if(a.success)switch(d.close(),_msg("Платёж успешно внесён!"),OPL.from){case "client":$("#income_spisok").html(a.html);
$(".left:first").html(a.balans);break;case "zayav":$("#income_spisok").html(a.html);$(".zdel").remove();break;case "income":incomeSpisok()}else d.abort()},"json")):(c("Необходимо указать комментарий"),$("#prim").focus()):(c("Некорректно указана сумма."),$("#sum").focus())}function c(a){d.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",remove:1,indent:40,show:1,top:-48,left:115})}var b='<table class="income-add-tab">'+(OPL.client_fio?'<tr><td class="label">Клиент:<td>'+OPL.client_fio:"")+(OPL.zayav_name?
'<tr><td class="label">Заявка:<td><b>'+OPL.zayav_name+"</b>":"")+'<tr><td class="label">Вид платежа:<td><input type="hidden" id="income_id_add"><a href="'+URL+'&p=gazeta&d=setup&d1=money" class="img_edit'+_tooltip("Настройка видов платежей",-85)+'</a><tr><td class="label">Сумма:<td><input type="text" id="sum" class="money" maxlength="11"> руб.<tr><td class="label">Комментарий:<td><input type="text" id="prim" maxlength="100"></table>',d=_dialog({width:400,head:"Внесение платежа",content:b,submit:a});
$("#sum").focus();$("#sum,#prim").keyEnter(a);$("#income_id_add")._select({width:180,title0:"Не указан",spisok:INCOME_SPISOK,func:function(a){$("#sum").focus()}})}).on("click",".income-del",function(){for(var a=$(this),c=_dialog({width:300,head:"Удаление платежа",content:"<center><b>Подтвердите удаление платежа.</b></center>",butSubmit:"Удалить",submit:function(){var b={op:"income_del",id:a.attr("val")};c.process();$.post(AJAX_GAZ,b,function(b){b.success?(a.remove(),c.close(),_msg("Платёж удалён")):
c.abort()},"json")}});"TR"!=a[0].tagName;)a=a.parent()}).on("click","#income_next",function(){var a=$(this),c={op:"income_spisok",page:$(this).attr("val"),limit:$("#money_limit").val(),client_id:$("#money_client_id").val(),zayav_id:$("#money_zayav_id").val(),deleted:$("#money_deleted").val(),income_id:$("#money_income_id").val(),worker_id:$("#money_worker_id").val(),day:$(".selected").val()||""};a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_GAZ,c,function(b){b.success?a.after(b.html).remove():
a.removeClass("busy")},"json"))}).on("click",".expense #monthList div",expenseSpisok).on("click",".expense ._next",function(){var a=$(this),c=expenseFilter();c.page=a.attr("val");a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_GAZ,c,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json"))}).on("click",".expense .img_del",function(){for(var a=$(this),c=_dialog({width:300,head:"Удаление расхода",content:"<center><b>Подтвердите удаление расхода.</b></center>",butSubmit:"Удалить",
submit:function(){var b={op:"expense_del",id:a.attr("val")};c.process();$.post(AJAX_GAZ,b,function(b){b.success?(a.remove(),c.close(),_msg("Расход удалён")):c.abort()},"json")}});"TR"!=a[0].tagName;)a=a.parent()}).on("click",".invoice_set",function(){function a(){var a={op:"invoice_set",invoice_id:c,sum:$("#sum").val()};REGEXP_CENA.test(a.sum)?(b.process(),$.post(AJAX_GAZ,a,function(a){a.success?($("#invoice-spisok").html(a.i),b.close(),_msg("Баланс установлен.")):b.abort()},"json")):(b.bottom.vkHint({msg:'<SPAN class="red">Некорректно указана сумма</SPAN>',
...
indent:60,top:-64,left:-61}),$("#gnyear").years({center:zayavSpisok,func:zayavSpisok}),$("#nomer")._select({title0:"Номер не указан",spisok:GN_SEL,func:zayavSpisok}),zayavPub());$("#zayav-add").length&&($("#client_id").clientSel({add:1,func:function(a,c,b){ZA.skidka=a?b.skidka:"";$("#skidka")._select(ZA.skidka);window.gnGet.skidka(ZA.skidka);"0"==$("#summa_manual").val()&&$("#summa").val(window.gnGet.summa());$("#skidka-txt").html(window.gnGet.skidka())}}),$("#category")._select({width:120,spisok:CATEGORY_SPISOK,
...
a+"</SPAN>",remove:1,indent:40,show:1,top:-58,left:-14})}var c=$(this),b={op:"zayav_add",client_id:$("#client_id").val(),category:$("#category").val(),rubric_id:$("#rubric_id").val(),rubric_sub_id:$("#rubric_sub_id").val(),txt:$("#ztxt").val(),telefon:$("#telefon").val(),adres:$("#adres").val(),size_x:$("#size_x").val(),size_y:$("#size_y").val(),gns:window.gnGet.result(),skidka:$("#skidka").val(),summa_manual:$("#summa_manual").val(),note:$("#note").val()};1==b.category&&0==b.rubric_id?a("Не указана рубрика"):
1!=b.category||b.txt?1!=b.category||b.telefon||b.adres?2==b.category&&0==b.client_id?a("Не выбран клиент"):2!=b.category||REGEXP_CENA.test(b.size_x)&&REGEXP_CENA.test(b.size_y)?b.gns?"no_polosa"==b.gns?a("Необходимо указать полосы у всех номеров"):REGEXP_CENA.test($("#summa").val())?(c.addClass("busy"),$.post(AJAX_GAZ,b,function(a){a.success?(_msg("Заявка внесена."),location.href=URL+"&p=gazeta&d=zayav&d1=info&id="+a.id):c.removeClass("busy")},"json")):(a("Некорректно введена итоговая стоимость"),
...
indent:120,top:17,left:426}),$(".zdel").click(function(){var a=_dialog({top:90,width:260,head:"Удаление заявки",content:"<center><b>Подтвердите удаление заявки</b></center>",butSubmit:"Удалить",submit:function(){var c={op:"zayav_del",id:OPL.zayav_id};a.process();$.post(AJAX_GAZ,c,function(b){b.success?(a.close(),_msg("Заявка удален."),ADMIN?location.reload():location.href=URL+"&p=gazeta&d=client"):a.abort()},"json")}})}),$("#lost-count").click(function(){$(this).parent().find(".lost").show();$(this).remove()}),
...
1==ZAYAV.category&&(b.rubric_id=$("#rubric_id").val(),b.rubric_sub_id=$("#rubric_sub_id").val(),b.txt=$("#ztxt").val(),b.telefon=$("#telefon").val(),b.adres=$("#adres").val());2==ZAYAV.category&&(b.size_x=$("#size_x").val(),b.size_y=$("#size_y").val(),b.skidka=$("#skidka").val());3>ZAYAV.category&&(b.summa_manual=$("#summa_manual").val());1==ZAYAV.category&&0==b.rubric_id?a("Не указана рубрика"):1!=ZAYAV.category||b.txt?1!=ZAYAV.category||b.telefon||b.adres?2==ZAYAV.category&&0==b.client_id?a("Не выбран клиент"):
2!=ZAYAV.category||REGEXP_CENA.test(b.size_x)&&REGEXP_CENA.test(b.size_y)?"no_polosa"==b.gns?a("Необходимо указать полосы у всех номеров"):REGEXP_CENA.test($("#summa").val())?(c.addClass("busy"),$.post(AJAX_GAZ,b,function(a){a.success?(_msg("Заявка изменена."),location.href=URL+"&p=gazeta&d=zayav&d1=info&id="+ZAYAV.id):c.removeClass("busy")},"json")):(a("Некорректно введена итоговая стоимость"),$("#summa").focus()):a("Некорректно указан размер блока"):(a("Укажите контактный телефон или адрес клиента"),
...
$("#monthList input"),c=0;for(n=1;12>=n;n++)if(0==a.eq(n-1).val()){c=1;break}for(n=1;12>=n;n++)$("#c"+n)._check(c);expenseSpisok()}}));$("#report.invoice").length&&$(".transfer").click(function(){function a(){var a={op:"invoice_transfer",from:1*$("#from").val(),to:1*$("#to").val(),sum:$("#sum").val(),note:$("#note").val()};a.from?a.to?a.from==a.to?c("Выберите другой счёт"):REGEXP_CENA.test(a.sum)&&0!=a.sum?(b.process(),$.post(AJAX_GAZ,a,function(a){a.success?($("#invoice-spisok").html(a.i),$("#transfer-spisok").html(a.t),
b.close(),_msg("Перевод произведён.")):b.abort()},"json")):(c("Некорректно введена сумма"),$("#sum").focus()):c("Выберите счёт-получатель"):c("Выберите счёт-отправитель")}function c(a){b.bottom.vkHint({msg:'<span class="red">'+a+"</span>",top:-47,left:92,indent:50,show:1,remove:1})}$(this);var b=_dialog({width:380,head:"Перевод между счетами",content:'<table class="invoice-transfer"><tr><td class="label">Со счёта:<td><input type="hidden" id="from" /><tr><td class="label">На счёт:<td><input type="hidden" id="to" /><tr><td class="label">Сумма:<td><input type="text" id="sum" class="money" /> руб. <tr><td class="label">Комментарий:<td><input type="text" id="note" /></table>',
