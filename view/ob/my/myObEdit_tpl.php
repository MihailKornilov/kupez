...
if(!$ob->id or $ob->viewer_id_add!=VIEWER_ID)  header("Location: ". URL."&my_page=vk-myOb");
...
$(document).ready(function(){
	...
	$("#vk_srok").vkSel({
		width:90,
		spisok:[{uid:1,title:'1 ������'},{uid:2,title:'2 ������'},{uid:3,title:'3 ������'}]
		});
...
function fileSelected()
	{
	$("#file_name").after("<IMG src=/img/upload.gif class=upload><A href='javascript:' onclick=tdUploadSet();>��������</A>");
...
<DIV id=vk-create>
	...
	<TR><TD class=tdAbout>�������:							<TD><INPUT TYPE=hidden id=rubrika name=rubrika value=<?php echo $ob->rubrika; ?>>
																						<TD><INPUT TYPE=hidden NAME=podrubrika id=podrubrika value=<?php echo $ob->podrubrika; ?>>
	<TR><TD class=tdAbout valign=top>�����:				<TD colspan=2><TEXTAREA name=txt id=txt><?php echo textUnFormat($ob->txt); ?></TEXTAREA>
	<TR><TD class='tdAbout top5' valign=top>��������� �����������:<TD colspan=2 id=tdUpload>
	<TR><TD class=tdAbout>���������� ��������:	<TD colspan=2><INPUT TYPE=text NAME=telefon id=telefon maxlength=200 value='<?php echo $ob->telefon; ?>'>
	<TR><TD class=tdAbout>�����:								<TD colspan=2><INPUT TYPE=text NAME=adres id=adres maxlength=200 value='<?php echo $ob->adres; ?>'>
	<TR><TD class=tdAbout>���������� ��� �� VK:	<TD colspan=2><INPUT TYPE=hidden NAME=vk_viewer_id_show id=vk_viewer_id_show value=<?php echo $ob->vk_viewer_id_show; ?>>
	<TR id=active><TD class=tdAbout>����:		<TD colspan=2><A href='javascript:' class=goarchiv onclick=goAcrhiv();>��������� � �����</A><INPUT TYPE=hidden NAME=vk_srok id=vk_srok value=<?php echo $ob->vk_srok; ?>>
	<TR id=archiv><TD class=tdAbout>&nbsp;		<TD colspan=2><SPAN>���������� ��������� � ������.</SPAN><A href='javascript:' onclick=goActive();>������� ��������</A>
	...
	<DIV id=zMsg></DIV>
	<DIV class=vkButton><BUTTON onclick=vkCreateGo();>���������</BUTTON></DIV><DIV class=vkCancel><BUTTON onclick="location.href='<?php echo URL."&my_page=vk-myOb"; ?>'">������</BUTTON></DIV>
